...
public class Majority {
    ...
    public static int major(int left,int right,int t,int[] nums){
        ...
        int occur=(length-freq)/2+freq;
        // System.out.println(length+"  "+occur);
        // System.out.println(n+"  "+freq+" "+ans);
        if(occur>=t){
